...
(function (quickstart) {
    class TranslationAnnotation {
        static main(args) {
            ...
            let logout = new quickstart.HTMLAnchorElementBuilder().href(TranslationAnnotation.LOGOUT_URL).textContent(" Clicca qui").build();
            let linkHome = new quickstart.HTMLAnchorElementBuilder().href(TranslationAnnotation.HOME_URL).textContent("Home").build();
