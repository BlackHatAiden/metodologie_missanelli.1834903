...
(function (quickstart) {
    class SenseAnnotation {
        static main(args) {
            ...
            let logout = new quickstart.HTMLAnchorElementBuilder().href(SenseAnnotation.LOGOUT_URL).textContent(" Clicca qui").build();
            let linkHome = new quickstart.HTMLAnchorElementBuilder().href(SenseAnnotation.HOME_URL).textContent("Home").build();
