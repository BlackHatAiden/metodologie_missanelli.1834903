...
(function (quickstart) {
    class SenseValidation {
        static main(args) {
            ...
            let logout = new quickstart.HTMLAnchorElementBuilder().href(SenseValidation.LOGOUT_URL).textContent(" Clicca qui").build();
            let linkHome = new quickstart.HTMLAnchorElementBuilder().href(SenseValidation.HOME_URL).textContent("Home").build();
