...
public class TranslationValidation 
{
	...
	public static void main(String[] args) 
	{
		...
		HTMLLabelElement labelInizio = new HTMLLabelElementBuilder().textContent("5. Data una parola scegliere la traduzione migliore")
																	.build() ;
		...
		HTMLLabelElement labelCheck4 = new HTMLLabelElementBuilder().textContent("Nessuna")
																	.build() ;
		...
		$.getJSON(REST_URL, "task=TRANSLATION_VALIDATION", (Object result, String a, JQueryXHR ctx) -> 
		{
			...
			String sTranslations1 = json.$get("translations1");
			String sTranslations2 = json.$get("translations2");
			String sTranslations3 = json.$get("translations3");
